...
extern  "C" {
    ...
    // MapR Note: If you link directly with libMapRClient instead of 
    // libhadoop, you can only connect to a maprfs cluster
    // To connect to local fs or hdfs, use libhadoop
    /** 
     * hdfsConnectAsUser - Connect to a maprfs file system as a specific user
     * Connect to the hdfs.
     * @param host A string containing either a host name, or an ip address
     * of the namenode of a maprfs cluster. 'host' should be passed as NULL if
     ...
     * @param user the user name (this is hadoop domain user). Or NULL is equivelant to hdfsConnect(host, port)
    ...
    // To connect to local fs or hdfs, use libhadoop
    /** 
     * hdfsConnect - Connect to a maprfs file system.
     * Connect to the maprfs.
     * @param host A string containing either a host name, or an ip address
     * of the namenode of a maprfs cluster. 'host' should be passed as NULL if
     * you want to connect to local filesystem. 'host' should be passed as
     * 'default' (and port as 0) to used the 'configured' filesystem
    ...
    /** 
     * hdfsDisconnect - Disconnect from the maprfs file system.
    ...
    /** 
     * hdfsOpenFile - Open a maprfs file in given mode.
     * @param fs The configured filesystem handle.
    ...
    /** 
     * hdfsPwrite - Positional write of data to an open file.
     * @param fs The configured filesystem handle.
     * @param file The file handle.
     * @param position Position to which to write
     * @param buffer The data.
     * @param length The no. of bytes to write. 
    ...
    // MapR Note: If you link directly with libMapRClient instead of 
    // libhadoop, hdfsCopy() is not supported and will always return -1
    // To use this api, use libhadoop
    /**
    ...
    // MapR Note: If you link directly with libMapRClient instead of 
    // libhadoop, hdfsMove() is not supported and will always return -1
    // To use this api, use libhadoop
    /**
    ...
    // MapR Note: Replication can be set only on a volume in MapR Hadoop.
    // This api is not supported, and will always return -1 in MapR Hadoop
    /** 
     ...
     * @param A 2-d array of blocks-hosts;
     */
     ...
     * @param fs The configured filesystem handle.
     * @param path the path to the file or directory
     * Returns the size of Name Container in bytes on success, else -1
     */    
